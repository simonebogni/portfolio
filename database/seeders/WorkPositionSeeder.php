    ...
    public function run()
    {
        $positions = [
            [
                ...
                'tags' => ['HTML5', 'CSS3', 'Bootstrap', 'Responsive Web Design', 'PHP', 'MySQL', 'JavaScript', 'jQuery', 'DataTables', 'D3.js', 'Ripcord (XML RPC)', 'Software Design', 'Database Design', 'UML', 'ERD', 'Web development', 'Single Page Application', 'Information System']
            ],
            [
