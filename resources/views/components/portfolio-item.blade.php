...
<div class="card card-portfolio-item mb-3 w-100">
    ...
    <div class="card-body card-body-portfolio-item pt-0">
        ...
        <div class="row pt-3">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <a type="button" class="btn btn-block purpleButtonOutline portfolio-item-git_repo-url" href="{{$item->git_repo_url}}" target="_blank" rel="noopener noreferrer">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <button class="btn btn-block purpleButtonOutline portfolio-item-gallery-button" id="gallery-button-{{$item->id}}" data-toggle="modal" data-target="#modal-gallery-{{$item->id}}">
